...
import { formatShortDate, getPastNDays } from '../../utils/dates';
import { calculateBooleanMetrics, calculateCounterMetrics } from '../../utils/metrics';
import { X, TrendingUp, TrendingDown, Minus, Activity as ActivityIcon } from 'lucide-react';
import {
  ResponsiveContainer,
  BarChart,
  Bar,
...
export const ActivityDetailModal: React.FC<ActivityDetailModalProps> = ({
  ...
  // Prepare chart data for last 14 or 30 days
          ...
          <div className="flex items-center justify-between p-4 bg-[#0c0c0d] border border-[#1e1e20] rounded-xl">
            ...
            <div className="text-right">
              ...
              <p className="text-xs font-semibold text-[#c5a059] uppercase tracking-wider font-mono">
                {activity.direction === 'increase'
                  ? 'Aumentar'
                  : activity.direction === 'decrease'
                  ? 'Reducir'
                  : 'Cumplir'}
              </p>
            </div>
